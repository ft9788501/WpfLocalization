...
namespace Localization.I18N
{
    ...
    {
        private static readonly Dictionary<string, string> olsonTimeZone2Win32TimeZoneMap = new Dictionary<string, string>()
        {
        ...
        /// <returns></returns>
        internal static TimeZoneInfo GetTimeZoneInfoByOlsonName(string olsonTimeZoneId)
        {
            var windowsTimeZoneId = default(string);
            var windowsTimeZone = default(TimeZoneInfo);
            if (olsonTimeZone2Win32TimeZoneMap.TryGetValue(olsonTimeZoneId, out windowsTimeZoneId))
            {
